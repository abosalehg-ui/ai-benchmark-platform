...
| **`Saudi Legal & Fiqh`** ⭐ | الأنظمة السعودية + الفقه | اختيار من متعدّد | 100 |
...
بنشمارك حصري لاختبار فهم النماذج للقانون السعودي والفقه الإسلامي — **100 سؤال** موثّق موزّع على **13 تصنيف** و **3 مستويات صعوبة** (سهل / متوسط / صعب):

| المجال | عدد الأسئلة | أمثلة |
|---------|:---:|---------|
| نظام العمل | 10 | فترة التجربة، مكافأة نهاية الخدمة، الإجازات، الأجر الإضافي |
| الإجراءات الجزائية | 8 | التوقيف، حقوق المتهم، الاستئناف، الإفراج |
| نظام التنفيذ | 7 | أوامر التنفيذ، الإفصاح، منع السفر، الإعسار |
| نظام الأحوال الشخصية | 8 | الزواج، الطلاق، الخلع، الحضانة، العدة |
| نظام مكافحة الجرائم المعلوماتية | 6 | التشهير، الاحتيال، اختراق الحسابات، الإرهاب الإلكتروني |
| نظام المرافعات الشرعية | 7 | الاختصاص، اليمين، التبليغ، النقض |
| نظام العقود (المعاملات المدنية) | 6 | انعقاد العقد، المسؤولية التقصيرية، الإثراء بلا سبب |
| نظام التحكيم | 6 | اتفاق التحكيم، البطلان، تنفيذ الحكم |
| **نظام الإثبات** ⭐ جديد | 6 | الكتابة، الشهادة، الإقرار، اليمين |
| **نظام الشركات** ⭐ جديد | 6 | ذ.م.م، المساهمة، التضامن، الشركة المهنية |
| فقه - عبادات | 11 | الصلاة، الزكاة، الصيام، المسح على الخفين |
| فقه - معاملات | 11 | الربا، التقسيط، المضاربة، الرهن، الإجارة المنتهية بالتمليك |
| فقه - الميراث | 8 | الفرائض، الحجب، العمريتان، الأكدرية |
