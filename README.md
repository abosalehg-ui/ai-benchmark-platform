...
| ⭐ **`Saudi Dialects`** | اللهجات السعودية (نجدية/حجازية/جنوبية/شرقية — متوازنة) | اختيار من متعدّد | 66 |
...
| التشغيلات المتوقّفة (ميزانية/انقطاع) مستبعَدة افتراضياً | هبوط وهمي من عيّنة ناقصة |
